<div class="flex gap-2">
    <!-- Edit Extension (Eye Icon) -->
    <button
        wire:click="$dispatch('editExtension', { id: @js($row->id) })"
    ...
    <!-- Delete Extension (Bin Icon) -->
    <button
        wire:click="$dispatch('deleteExtension', { id: @js($row->id) })"
        wire:confirm="{{ __('Are you sure you want to delete this extension?') }}"
